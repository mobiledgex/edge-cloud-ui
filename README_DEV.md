...
1. 주소창에 입력한 주소값으로 페이지 이동 - 주소값 : window.location.pathname - 페이지이동 : <Redirect push to={this.state.directLink} /> - 페이지이동 : this.router.history.push(pathName);
   #MEX
...
3. https://github.com/whawker/react-jsx-highcharts

4. http://beomy.tistory.com/37
5. npm install --save react-highcharts highcharts-drilldown
