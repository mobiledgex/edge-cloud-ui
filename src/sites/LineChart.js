...
export default class Demo extends Component {
    ...
    render() {
        ...
        return (
            <div className="line-charts" style={{overflowY: 'auto'}}>
                <a
                ...
                <div className='line-chart-wrapper' style={{padding: 40}}>
                    ...
                    >
                        ...
                        />
                        {this.state.newLine &&
                        <Line type='monotone' key={'1'} dataKey='amt' stroke='#132908' yAxisId={1}
                              activeDot={{fill: '#132908', stroke: 'none', r: 6}}/>}
                        <Line type='monotone' key={'2'} dataKey='pv' stroke='#387908' yAxisId={1}
