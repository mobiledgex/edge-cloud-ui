...
const options = [
    ...
    },
    {
        ...
        roles: [
            constant.ADMIN_MANAGER,
            constant.OPERATOR_MANAGER,
            constant.OPERATOR_CONTRIBUTOR
        ]
    },
    {
        label: "Flavors",
        ...
        return (
            ...
            >
                <Tooltip title={option.label} aria-label="add">
                    <ListItemIcon style={{ color: "#B1B2B4" }}>
                        {option.icon}
                    </ListItemIcon>
                </Tooltip>
                <ListItemText
                ...
                {option.subOptions ? (
                    expand ? (
                        <ExpandLess style={{ color: "#B1B2B4" }} />
                    ) : (
                        <ExpandMore style={{ color: "#B1B2B4" }} />
                    )
                ) : null}
            </ListItem>
        );
    ...
    return (
        <div className={classes.root}>
            ...
            <main className={classes.content}>
                <div className="contents_body">{page}</div>
            </main>
            <PopLegendViewer
                dimmer={false}
                open={openLegend}
