...
import '../monitoring/common/PageMonitoringStyles.css'
...
export default class ClockComponentMini extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <div style={{
                ...
                <div className='clockDivMini'>{this.state.dayOfWeek} {this.state.time}</div>
            </div>
        );
    }
}
