...
import {renderBarChartCore, renderPlaceHolderLoader} from "../PageMonitoringCommonService";
            ...
            <div className='page_monitoring_dual_column' style={{display: 'flex'}}>
                <div className='page_monitoring_dual_container' style={{flex: 1}}>
                    ...
                    <div className='page_monitoring_container'>
                        {this.props.loading ? renderPlaceHolderLoader() : renderBarChartCore(this.state.chartDataSet.chartDataList, this.state.chartDataSet.hardwareType, this, this.state.graphType, this.state.isResizeComplete)}
                    </div>
                </div>
            </div>
