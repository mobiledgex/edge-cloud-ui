...
export default hot(
    class WebSocketTestForClusterInst extends Component {
        ...
        getGrapHData(){
            ...
            const webSocket = new WebSocket(`${prefixUrl}/ws/api/v1/auth/metrics/cluster`)
