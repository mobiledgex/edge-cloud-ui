...
let cpuUsageListByInstace_new=[];
cpuSumUsageByInstJSON.map((oneInstance, index) => {
    ...
    usageValues.map(item => {
        ...
        if ( preDate >= startDate && preDate <= endDate){
            ...
            //console.log('sldkflskdflksdlfklsdkfk====>',usage);
...
console.log('cpuUsageListByInstace_new====>',cpuUsageListByInstace_new);
