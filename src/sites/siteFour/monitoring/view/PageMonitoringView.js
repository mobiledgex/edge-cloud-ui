...
export default withSize()(connect(PageDevMonitoringMapStateToProps, PageDevMonitoringMapDispatchToProps)((
        class PageDevMonitoring extends Component<PageMonitoringProps, PageDevMonitoringState> {
            ...
            makeUniqOrganizationName(appInstList) {
                let filterlist = []
                ...
                try {
                    return (
                        <ResponsiveReactGridLayout
                            ...
                            layout={this.state.layoutCloudletAdmin}
                        ...
                        >
                            {this.state.layoutCloudletAdmin.map((item, loopIndex) => {
                    ...
                    return (
                        <ResponsiveReactGridLayout
                            ...
                            onLayoutChange={async (layout) => {
                                ...
                                console.log(`currentClassification...renderGridLayoutForClusterAdmin===>`, layout);
                    ...
                    <div className="page_monitoring_dropdown_box" style={{alignSelf: 'center', justifyContent: 'center'}}>
                        ...
                        <TreeSelect
                            ...
                            onSelect={async (value, node, extra) => {
                                ...
                                //todo: devleoper!
                                if (node.isDev) {
                                    await this.setState({currentOrgView: 'dev'})
                                    let filteredAppInstList = this.state.appInstList.filter((item: TypeAppInst, index) => {
                                        return item.OrganizationName === value
                                    })

                                    markerListForMap = reducer.groupBy(filteredAppInstList, "Cloudlet");
                                    let uniq_filteredAppInstList = _.uniqBy(filteredAppInstList, 'Cloudlet')
                                    ...
                                    if (selectCloudlet === '0') {//todo:reset filter
                                        ...
                                        try {
                                            ...
                                            if (filteredClusterList.length > 0) {
                                                ...
                                                console.log(`date...endTime===>`, endTime)

                                                usageEventPromiseList.push(getAllClusterEventLogList(filteredClusterList))
                                                usageEventPromiseList.push(getClientStatusList(appInstList, startTime, endTime));
            ...
            renderGridLayoutByClassification() {
                if (this.state.currentClassification === CLASSIFICATION.CLOUDLET_FOR_ADMIN) {
                    return this.renderGridLayoutForCloudletAdmin()
                } else if (this.state.currentClassification === CLASSIFICATION.CLUSTER_FOR_ADMIN) {
