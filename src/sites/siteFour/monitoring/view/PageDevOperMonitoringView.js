...
export default withSize()(connect(PageDevMonitoringMapStateToProps, PageDevMonitoringMapDispatchToProps)((
        class PageDevMonitoring extends Component<PageMonitoringProps, PageDevMonitoringState> {
            ...
            getOnlyCloudletName(cloudletOne) {
            ...
            handleClusterDropdownForOper(clusterCloudlet) {
            ...
            async handleClusterDropdownForDev(selectedClusterOne) {
                try {
            ...
            renderGridLayoutForClusterForOper() {
                return (
                    <div>
                        opertator_clustersdfsdfsdfsdfsdf
                    </div>
                )
            }
                    ...
                    <AMenu>
                        ...
                        <AMenu.Item
                            ...
                            onClick={async () => {
                                {
                                    this.state.currentClassification === CLASSIFICATION.CLUSTER ?
                                        await this.handleClusterDropdownForDev('')
                                        :
                ...
                return (
                    <div className="page_monitoring_dropdown_box" style={{alignSelf: 'center', justifyContent: 'center'}}>
                        ...
                        <Select
                            showSearch={true}
                            dropdownStyle={{}}
                            notFoundContent={<div style={{color: 'orange', marginLeft: 5}}>No Cluster</div>}
                            listHeight={512}
                            style={{width: 250, maxHeight: '512px !important'}}
                    ...
                    <div className="page_monitoring_dropdown_box" style={{alignSelf: 'center', justifyContent: 'center'}}>
                        ...
                        <TreeSelect
                            ...
                            onChange={async (value, label, extra) => {
                                ...
                                await this.handleClusterDropdownForDev(value.trim())
                            }}
                        />
                    </div>
                )
                            ...
                            return (
                                <Col
                                    ...
                                    onClick={async () => {
                                        ...
                                        await this.handleClusterDropdownForDev(clusterOne)
                    ...
                    <>
                        <Toolbar className='monitoring_title' style={{marginTop: -5}}>
                            <label className='content_title_label' style={{marginBottom: 1}}
                                   onClick={() => {
                                       this.state.userType.includes(USER_TYPE.OPERATOR) ? this.handleCloudletDropdownForOper(undefined) : this.handleClusterDropdownForDev('')
                                   }}
                            >
                                Monitoring
                                        ...
                                        <CustomSwitch
                                            ...
                                            onChange={async () => {
                                                ...
                                                if (!this.state.isStream) {
                                                    ...
                                                    await this.handleClusterDropdownForDev(this.state.currentCluster)
                            ...
                            <div style={{
                                ...
                                <div className="page_monitoring"
                                    ...
                                    {this.state.currentClassification === CLASSIFICATION.CLOUDLET ? this.renderGridLayoutForCloudletForOper()
                                        : this.state.currentClassification === CLASSIFICATION.CLUSTER_FOR_OPER ? this.renderGridLayoutForClusterForOper()
