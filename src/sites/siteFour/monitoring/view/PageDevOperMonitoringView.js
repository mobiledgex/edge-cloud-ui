        ...
        class PageDevMonitoring extends Component<PageMonitoringProps, PageDevMonitoringState> {
            ...
            setClusterInterval() {
                ...
                this.intervalForCluster = setInterval(async () => {
                    ...
                    try {
                        console.log(`filteredClusterList==111==>`, this.state.filteredClusterList);
            ...
            async addGridItem(paramHwType, graphType = 'line') {
                ...
                if (this.state.currentClassification === CLASSIFICATION.CLOUDLET) {
                    ...
                    let mapperList = this.state.layoutMapperCloudlet
                    ...
                    //@desc: ######################################
                    await this.setState({
                        layoutCloudlet: this.state.layoutCluster.concat({
                            i: uniqueId,
            ...
            showBigModal = (paramHwType, graphType) => {
                ...
                try {
                    ...
                    if (graphType.toUpperCase() == GRID_ITEM_TYPE.LINE) {
                        ...
                        console.log(`_resuit====>`, _resuit);

                        chartDataSets = makeLineChartDataForBigModal(_resuit, this)
                ...
                try {
                    if (this.state.userType.includes(USER_TYPE.DEVELOPER)) {
                        ...
                        await this.setState({
                            ...
                            layoutClusterForOper: defaultLayoutForClusterForOper,
                            layoutMapperClusterForOper: defaultLayoutMapperForClusterForOper,
                        })
                    }
