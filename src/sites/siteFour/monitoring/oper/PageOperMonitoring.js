...
import {PageMonitoringStyles, renderLoaderArea, renderPlaceHolderSkeleton, showToast} from "../PageMonitoringCommonService";
                ...
                <div className='page_monitoring_dual_column'>
                    ...
                    <div className='page_monitoring_dual_container'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton() : makeBarChartDataForCloudlet(this.state.filteredCloudletUsageList, HARDWARE_TYPE.VCPU)}
                        </div>
                    </div>
                    {/*2nd_column*/}
                    {/*2nd_column*/}
                    ...
                    <div className='page_monitoring_dual_container'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton() : makeLineChartForCloudlet(this, this.state.filteredCloudletUsageList, HARDWARE_TYPE.VCPU)}
                        </div>
                    </div>
                </div>
            )
            ...
            return (
                <div className='page_monitoring_dual_column'>
                    ...
                    <div className='page_monitoring_dual_container'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton() : makeBarChartDataForCloudlet(this.state.filteredCloudletUsageList, HARDWARE_TYPE.MEM)}
                        </div>
                    </div>
                    {/*2nd_column*/}
                    {/*2nd_column*/}
                    ...
                    <div className='page_monitoring_dual_container'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton() : makeLineChartForCloudlet(this, this.state.filteredCloudletUsageList, HARDWARE_TYPE.MEM)}
                        </div>
                    </div>
            ...
            return (
                <div className='page_monitoring_dual_column'>
                    ...
                    <div className='page_monitoring_dual_container'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton() : makeBarChartDataForCloudlet(this.state.filteredCloudletUsageList, HARDWARE_TYPE.DISK)}
                        </div>
                    </div>
                    {/*2nd_column*/}
                    <div className='page_monitoring_dual_container'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton() : makeLineChartForCloudlet(this, this.state.filteredCloudletUsageList, HARDWARE_TYPE.DISK)}
                        </div>
                    </div>
                </div>
            )
            ...
            return (
                <div className='page_monitoring_dual_column'>
                    ...
                    <div className='page_monitoring_dual_container'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton() : makeBarChartDataForCloudlet(this.state.filteredCloudletUsageList, HARDWARE_TYPE.FLOATING_IPS)}
                        </div>
                    </div>
                    {/*2nd_column*/}
                    <div className='page_monitoring_dual_container'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton() : makeLineChartForCloudlet(this, this.state.filteredCloudletUsageList, HARDWARE_TYPE.FLOATING_IPS)}
                        </div>
                    </div>
                </div>
            )
            ...
            return (
                <div className='page_monitoring_dual_column'>
                    ...
                    <div className='page_monitoring_dual_container'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton() : makeBarChartDataForCloudlet(this.state.filteredCloudletUsageList, HARDWARE_TYPE.IPV4)}
                        </div>
                    </div>
                    {/*2nd_column*/}
                    <div className='page_monitoring_dual_container'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton() : makeLineChartForCloudlet(this, this.state.filteredCloudletUsageList, HARDWARE_TYPE.IPV4)}
                        </div>
                    </div>
                </div>
            )
            ...
            return (
                <div className='page_monitoring_dual_column'>
                    <div className='page_monitoring_dual_container'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton('network') : makeBarChartDataForCloudlet(this.state.allCloudletUsageList, networkType, this)}
                        </div>
                    </div>
                    <div className='page_monitoring_dual_container'>
                        <div className='page_monitoring_title_area'>
                        ...
                        <div className='page_monitoring_container'>
                            {this.state.loading ? renderPlaceHolderSkeleton('network') : makeLineChartForCloudlet(this, this.state.allCloudletUsageList, networkType)}
                        </div>
                    </div>
                </div>
            )
                                        ...
                                        <div className='page_monitoring_dashboard'>
                                            ...
                                            <div className='page_monitoring_row'>
                                                ...
                                                <div className='page_monitoring_column'>
                                                    ...
                                                    {/*todo:---------------------------------*/}
                                                    <div className='page_monitoring_container'>
                                                        {this.state.loading ? renderPlaceHolderSkeleton() : renderBubbleChartForCloudlet(this, this.state.currentHardwareType, this.state.bubbleChartData)}
                                                    </div>
                                                </div>
