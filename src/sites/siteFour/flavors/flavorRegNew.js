...
class ClusterInstReg extends React.Component {
    ...
    formKeys = () => {
        return [
            ...
            { field: fields.ram, label: 'RAM Size', formType: INPUT, placeholder: 'Enter RAM Size (MB)', unit: 'MB', rules: { required: true }, visible: true },
            { field: fields.vCPUs, label: 'Number of vCPUs', formType: INPUT, placeholder: 'Enter App Version', rules: { required: true }, visible: true },
            { field: fields.disk, label: 'Disk Space', formType: INPUT, placeholder: 'Enter Disk Space (GB)', unit: 'GB', rules: { required: true }, visible: true },
