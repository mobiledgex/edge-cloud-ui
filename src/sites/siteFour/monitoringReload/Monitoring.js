        ...
        return (
            <div style={{ flexGrow: 1 }} mex-test="component-monitoring">
                <Card>
                    ...
                    <MonitoringToolbar defaultParent={this.defaultMetricParentTypes} regions={this.regions} organizations={organizations} metricTypeKeys={this.defaultMetricParentTypes.metricTypeKeys} onChange={this.onToolbar} range={range} duration={duration} />
