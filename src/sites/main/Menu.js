...
const pages = [
    ...
    { label: 'Cloudlet Pools', icon: 'cloud_circle', id: constant.PAGE_CLOUDLET_POOLS, path: 'cloudlet-pools', roles: [constant.ADMIN, constant.OPERATOR_MANAGER, constant.OPERATOR_CONTRIBUTOR] },
