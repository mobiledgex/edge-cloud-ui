...
export const keys = () => ([
    ...
    { field: fields.appName, label: 'App Name', sortable: true, serverField: 'key#OS#app_key#OS#name', visible: true, filter: true, group: true, key: true },
    ...
    { field: fields.state, label: 'State', sortable: true, serverField: 'state', visible: true, filter: true, group: true, key: true },
])
