...
const keys = () => (
    [
        ...
        { label: 'App', field: localFields.appName, serverField: 'app', visible: true, groupBy: 2, filter: true },
        { label: 'Version', field: localFields.version, serverField: 'ver', visible: true, groupBy: 2 },
        { label: 'App Developer', field: localFields.organizationName, serverField: 'apporg', visible: true, groupBy: 2 },
        { label: 'Cluster', field: localFields.clusterName, serverField: 'cluster', visible: true, groupBy: 2 },
        { label: 'Cluster Developer', field: localFields.clusterdeveloper, serverField: 'clusterorg', visible: true, groupBy: 2 },
