...
export const keys = () => ([
  ...
  { field: fields.partnerOperator, serverField: 'key#OS#cluster_inst_key#OS#cloudlet_key#OS#federated_organization', label: 'Federation organization', visible: false, key: true },
