...
export const showAlertKeys = () => (
    [
        ...
        { field: fields.appName, serverField: 'labels#OS#app', label: 'App', sortable: true, visible: false, summary: true },
        { field: fields.appDeveloper, serverField: 'labels#OS#apporg', label: 'App Developer', sortable: true, visible: false, summary: true },
        { field: fields.appDeveloper, serverField: 'labels#OS#apporg', label: 'App Developer', sortable: true, visible: false, summary: true },
        { field: fields.version, serverField: 'labels#OS#appver', label: 'App Version', sortable: true, visible: false, summary: true },
        { field: fields.cloudletName, serverField: 'labels#OS#cloudlet', label: 'Cloudlet', sortable: true, visible: false, summary: true },
        { field: fields.operatorName, serverField: 'labels#OS#cloudletorg', label: 'Operator', sortable: true, visible: false, summary: true },
        { field: fields.clusterName, serverField: 'labels#OS#cluster', label: 'Cluster', sortable: true, visible: false, summary: true },
        { field: fields.clusterdeveloper, serverField: 'labels#OS#clusterorg', label: 'Cluster Developer', sortable: true, visible: false, summary: true },
        ...
        { field: fields.state, serverField: 'state', label: 'State', sortable: true, visible: false, summary: true },
        { field: fields.activeAt, serverField: 'active_at', label: 'Active At', sortable: true, visible: false, summary: true },
