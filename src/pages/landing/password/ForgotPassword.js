...
const Message = (props) => {
    ...
    return (
        <Grid>
            <Grid.Row>
                <span className='title'>{type === perpetual.VERIFY_PASSWORD ? 'Reset Password' : 'Verify Email'}</span>
            </Grid.Row>
            <Grid.Row>
...
const ForgotPassword = (props) => {
    ...
    return (success ?
        <Message type={type} /> :
        <React.Fragment><span className='title'>{type === perpetual.VERIFY_PASSWORD ? 'Recover your password' : 'Verify your email'}</span>
            <Grid >
                <Grid.Row>
                    <Grid.Column>
