...
class Reg extends React.Component {
    ...
    getForms = () => ([
        ...
        { field: fields.alertPolicyName, label: 'Trust Policy Name', formType: INPUT, placeholder: 'Enter Alert Policy Name', rules: { required: true }, visible: true, update: { key: true }, tip: 'Alert Policy name' },
