...
class RegisterOperator extends React.Component {
    ...
    elements = () => {
        return [
            ...
            { field: fields.countryCode, label: 'Country Code', formType: SELECT, placeholder: 'Select Country Code', rules: { required: true }, visible: true, update: { key: true }, tip: 'Country where operator platform is located' },
