...
class RegisterPartner extends React.Component {
    ...
    elements = () => {
        return [
            ...
            { field: fields.countryCode, label: ' Country Code', formType: INPUT, placeholder: 'Enter Country Code', rules: { required: true, disabled: true, type: 'search' }, visible: true, tip: 'Country where operator platform is located' },
