...
class CloudletReg extends React.Component {
    ...
    formKeys = () => {
        return [
            ...
            { field: localFields.singleK8sClusterOwner, formType: this.isUpdate ? INPUT : SELECT, placeholder: 'Select Single Kubernetes Cluster Owner', label: 'Single K8s Owner', visible: true, tip: 'single K8s cluster cloudlet platforms, cluster is owned by this organization instead of multi-tenant.', advance: false },
