...
class headerGlobalMini extends React.Component {
    ...
    menuAdmin = () => (
        <Button.Group vertical>
            ...
            <Button style={{}} onClick={() => this.gotoPreview('/logout')}><div>{(this.props.location.pathname === "/site4")? this.state.userInfo['Name'] : this.state.userInfo['Name']}</div><div>Logout</div></Button>
        </Button.Group>
                ...
                <Popup
                    trigger={
                        <div style={{cursor:'pointer'}}>
                            ...
                            <span>
                                {(this.props.location.pathname === "/site4")? this.state.userInfo['Name'] :this.state.userInfo['Name']}
                            </span>
                        </div>}
                    content={
                        this.menuAdmin()
