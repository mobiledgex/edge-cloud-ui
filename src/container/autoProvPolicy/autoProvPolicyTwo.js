    ...
    render (){
        ...
        return (
            <Fragment>
                <Grid>
                    <Grid.Column>
                        <div><CreateAutoPolicyForm data={this.state.devData} step={step} pId={2} getUserRole={this.props.userrole} gotoUrl={this.props.gotoUrl} toggleSubmit={this.props.toggleSubmit} validError={this.props.error || []} onSubmit={() => console.log('submit form')} changeNext={'201'} editMode={this.props.editMode ? this.props.editMode : null}/></div>
                    </Grid.Column>
                </Grid>
            </Fragment>
        )
