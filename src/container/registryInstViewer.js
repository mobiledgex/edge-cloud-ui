...
const panes = [
    { menuItem: 'k8s deployment', render: (props) => <Tab.Pane attached={false}><SiteFourCreateFormDefault data={props} pId={0} onSubmit={() => console.log('submit form')}/></Tab.Pane> },
    { menuItem: 'Docker deployment', render: () => <Tab.Pane  attached={false} pId={1}>None</Tab.Pane> },
    { menuItem: 'VM deployment', render: () => <Tab.Pane attached={false} pId={2}>Nonw</Tab.Pane> }
]
        ...
        this.keysData = [
            {
                ...
                'Operator':{label:'Operator', type:'RenderInput', necessary:true, tip:null, active:true},
                'Cloudlet':{label:'Cloudlet', type:'RenderInput', necessary:true, tip:null, active:true},
