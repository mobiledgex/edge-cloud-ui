...
export const ipAccessFlowApp = (data, type) => {
    ...
    if (data[fields.accessType] === constant.ACCESS_TYPE_LOAD_BALANCER) {
        ...
        dataList.push({ type: 'nodes', data: { id: 10002, shape: SHAPE_ELLIPSE, width: 1, height: 1, bg: '#FFF' }, position: { x: 340, y: 200 } })
    ...
    return (
        {
            id: 3, dataList: count === 0 ? [] : [
                ...
                { type: 'nodes', data: { id: 30001, shape: SHAPE_ELLIPSE, width: 80, height: 40, bg: '#8893D0', bi: svgIcons.renderNode(svgIcons.ICON_UNLOCK, 10).svg, zi: 4 }, position: { x: 340, y: 165 } },
...
export const deploymentTypeFlow = (data, type) => {
    ...
    if (data[fields.deployment] === constant.DEPLOYMENT_TYPE_KUBERNETES || data[fields.deployment] === constant.DEPLOYMENT_TYPE_HELM) {
        ...
        dataList.push({ type: 'nodes', data: { id: 20002, shape: SHAPE_ROUND_RECTANGLE, width: 170, height: 100, bg: '#FFB97F', bw: 2, bc: '#ffd9ba', zi: 1 }, position: { x: 910, y: 190 } })
        dataList.push({ type: 'nodes', data: { id: 20003, shape: SHAPE_ROUND_RECTANGLE, width: 170, height: 100, bg: '#FFB97F', bw: 2, zi: 2, bc: '#ffd9ba' }, position: { x: 915, y: 195 } })
