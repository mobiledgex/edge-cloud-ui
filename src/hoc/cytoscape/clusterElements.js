...
export const ipAccessFlowApp = (data, type) => {
    ...
    if (data[fields.accessType] === constant.ACCESS_TYPE_LOAD_BALANCER) {
        ...
        dataList.push({ type: 'edges', data: { id: 10010002, source: 100, target: 10002, zi: 3, as: 'none', ls: 'dotted', lc: flowColor, se: '0% 8%' } })
        dataList.push({ type: 'edges', data: { id: 10002102, source: 10002, target: 102, zi: 3, as: 'none', ls: 'dotted', te: '-20% 10%', lc: flowColor }, classes: 'taxi' })
    }
    ...
    {   
        ...
        dataList.push({ type: 'edges', data: { id: 10010002, source: 100, target: 10002, ls: 'dotted', zi: 3, lc: flowColor, tdn: '50px', tac:flowColor } })
    }
    return (
        {
    ...
    return (
        {
            id: 3, dataList: count === 0 ? [] : [
                ...
                { type: 'edges', data: { id: 1003, source: 100, target: 3, zi: 3, as: 'none', ls: 'dotted', lc: flowColor, se: '0% -10%' } },
                { type: 'edges', data: { id: 330001, source: 3, target: 30001, zi: 3, as: 'none', ls: 'dotted', lc: flowColor } },
                { type: 'edges', data: { id: 30000102, source: 30001, target: 102, zi: 3, as: 'none', ls: 'dotted', lc: flowColor }, classes: 'taxi' },
            ],
...
export const deploymentTypeFlow = (data, type) => {
    ...
    if (data[fields.deployment] === constant.DEPLOYMENT_TYPE_KUBERNETES || data[fields.deployment] === constant.DEPLOYMENT_TYPE_DOCKER) {
        if (data[fields.deployment] === constant.DEPLOYMENT_TYPE_KUBERNETES) {
            ...
            dataList.push({ type: 'edges', data: { id: 1022, source: 102, target: 2, as: 'none', ls: 'dotted', zi: 3, lc: flowColor, te: '60% 0%' }, classes: 'taxi' })
            dataList.push({ type: 'edges', data: { id: 2103, source: 2, target: 103, as: 'none', ls: 'dotted', zi: 3, se: '60% 0%', lc: flowColor } })
            ...
            dataList.push({ type: 'edges', data: { id: 10420004, source: 104, target: 20004, ls: 'dotted', zi: 3, lc: flowColor, tdn: '50px', tac:flowColor }, classes: 'taxi' })
            dataList.push({ type: 'edges', data: { id: 103104, source: 103, target: 104, ls: 'dotted', zi: 3, lc: flowColor, as: 'none' } })
        }
            ...
            if (data[fields.accessType] === constant.ACCESS_TYPE_LOAD_BALANCER) {
                ...
                dataList.push({ type: 'edges', data: { id: 1022, source: 102, target: 2, ls: 'dotted', zi: 3, lc: flowColor, tdn: '50px', tac:flowColor }, classes: 'taxi' })
            }
            else if (data[fields.accessType] === constant.ACCESS_TYPE_DIRECT) {
