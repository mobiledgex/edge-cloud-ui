...
export const shared = () => (
    {
        ...
        edgeList: [
            { data: { id: 1001, source: 100, target: 1 } },
            { data: { id: 1101, source: 1, target: 101, te: '-43% -43%', as:'none' } }
        ],
...
export const k8Master = () => (
    {
        id: 2, dataList: [
            ...
            { data: { id: 31, shape: constant.SHAPE_ROUND_RECTANGLE, width: 170, height: 100, bg: '#FFB97F', bw:1 }, position: { x: 900, y: 185 } },
            { data: { id: 32, shape: constant.SHAPE_ROUND_RECTANGLE, width: 170, height: 100, bg: '#FFB97F', bw:1 }, position: { x: 905, y: 190 } },
            { data: { id: 3, shape: constant.SHAPE_ROUND_RECTANGLE, label: 'K8s Nodes', width: 170, height: 100, bg: '#FFB97F', bw:1 }, position: { x: 910, y: 195 } },
        ],
        edgeList: [
            { data: { id: 2101, source: 2, target: 101, te: '0% 0%', as:'none' } },
            { data: { id: 3101, source: 3, target: 101, te: '44% 44%', as:'none' } }
        ], 
