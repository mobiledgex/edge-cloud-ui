...
const calculateControlPoint = (data) => {
    let src = data[0]
    let latlngs = [];
...
class MexCurve extends React.Component {
    ...
    render() { return <CurveLeaflet positions={calculateControlPoint(this.props.data)} option={{ color: this.props.color, fill: false, dashArray:'10'}}/> }
}
