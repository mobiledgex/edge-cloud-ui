...
export const CHART_COLOR_LIST = ['#DE0000', '#FF9600', '#FFF600', '#5BCB00', '#0096FF', '#66D9EF', '#FFC0CB', '#75715E', '#808000', '#000080', '#808000', '#800000']
export const CHART_COLOR_LIST2 = ['#65DEF1', '#A8DCD1', '#DCE2C8', '#F96900', '#F17F29', '#66D9EF', '#FFC0CB', '#75715E', '#808000', '#000080', '#808000', '#800000']
export const CHART_COLOR_LIST3 = ['#008000', '#d7fff1', '#556B2F', '#32CD32', '#8cd790', '#66D9EF', '#FFC0CB', '#75715E', '#808000', '#000080', '#808000', '#800000']
export const CHART_COLOR_LIST4 = ['#FF0000', '#FFBDAA', '#D4826A', '#802D15', '#551300', '#66D9EF', '#FFC0CB', '#75715E', '#808000', '#000080', '#808000', '#800000']
export const CHART_COLOR_MONOKAI = ['#F92672', '#FD971F', '#A6E22E', '#E6DB74', '#A6E22E', '#66D9EF', '#FFC0CB', '#75715E', '#808000', '#000080', '#808000', '#800000']
export const CHART_COLOR_APPLE = ['#0A84FF', '#30D158', '#FF453A', '#FF9F0A', '#FF375F', '#FFC0CB', '#808000', '#000080', '#FFFF00', '#800000']
export const CHART_COLOR_EXOTIC_ORCHIDS = ['#72a2c0', '#00743f', '#f2a104', '#192e5b', '#1d65a6', '#66D9EF', '#FFC0CB', '#75715E', '#808000', '#000080', '#808000', '#800000']
export const CHART_COLOR_URBAN_SKYLINE = ['#522E75', '#7e7d7b', '#52591F', '#A3765D', '#714E3D', '#66D9EF', '#FFC0CB', '#75715E', '#808000', '#000080', '#808000', '#800000']
export const CHART_COLOR_BERRIES_GALORE = ['#777CA8', '#BB1924', '#EE6C81', '#F092A5', '#AFBADC', '#66D9EF', '#FFC0CB', '#75715E', '#808000', '#000080', '#808000', '#800000']
export const CHART_COLOR_BRIGHT_AND_ENERGETIC = ['#F14D49', '#002485', '#118C8B', '#BCA18D', '#F2746B', '#66D9EF', '#FFC0CB', '#75715E', '#808000', '#000080', '#808000', '#800000']
export const CHART_COLOR_EARTHY_AND_NATURAL = ['#E4EBF2', '#52733B', '#84A45A', '#818A6F', '#715E4E', '#66D9EF', '#FFC0CB', '#75715E', '#808000', '#000080', '#808000', '#800000']
export const CHART_COLOR_JAZZ_NIGHT = ['#C59CDB', '#DFD0F1', '#A67B04', '#F3EED6', '#701B05', '#66D9EF', '#FFC0CB', '#75715E', '#808000', '#000080', '#808000', '#800000']
