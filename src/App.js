    ...
    return (
        (self.routeCnt === 1) ?
            ...
            <div style={{height: '100%', width: '100%', backgroundColor: 'transparent'}}>
                ...
                {props.mainPath === '/site1' &&
                <EntranceGlob params={_params} history={(props2.history) ? props2.history : null}/>}
                {props.mainPath === '/site2' &&
                <SiteTwo params={_params} history={(props2.history) ? props2.history : null}/>}
                {props.mainPath === '/site3' &&
                <SiteThree params={_params} history={(props2.history) ? props2.history : null}
                           selectedCloudlet={self.state.selectedCloudlet}/>}
                ...
                {(self.props.creatingSpinner == true) ?
                    <div className="loadingBox" style={{zIndex: 99999}}>
                        <GridLoader
                            ...
                            //loading={true}
                        />
                        <span className={self.props.creatingSpinner ? '' : 'loading'}
        ...
        return (
            <Router history={history} ref={router => this.router = router}>
                <div style={{width: '100%', height: '100%'}}>
                    ...
                    <Route exact path='/PageMonitoringDetail' component={PageMonitoringDetail} />
                </div>
            </Router>
        );
    }
