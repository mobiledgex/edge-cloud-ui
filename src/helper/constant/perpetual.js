...
export const UPDATE_BUILD = 'UpdateBuild'
...
export const PAGE_GPU_DRIVER = 'GPU Driver'

export const OS_UNKNOWN = UNKNOWN
export const OS_LINUX = 'Linux'
export const OS_WINDOWS = 'Windows'
export const OS_OTHERS = 'Others'
export const OS_WINDOWS_10 = 'Windows 10'
export const OS_WINDOWS_2012 = 'Windows 2012'
export const OS_WINDOWS_2016 = 'Windows 2016'
export const OS_WINDOWS_2019 = 'Windows 2019'
